...
func isIdentityTalk(s string) bool {
	...
	keys := []string{
		...
		"de qué estás hecho", "de que estas hecho", "de qué estas hecho", "de que estás hecho",
		"cómo estás hecho", "como estas hecho", "como estás hecho", "cómo estas hecho",
		"cuál es tu estructura", "cual es tu estructura", "tu estructura",
		"cómo te consideras", "como te consideras", "qué valoración te das", "que valoracion te das",
